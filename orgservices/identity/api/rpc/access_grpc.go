...
// 	"time"
//
// 	proto "github.com/timoth-y/chainmetric-network/orgservices/identity/api/proto/access"
...
// 	_ context.Context,
// 	request *proto.FabricCredentialsRequest,
// ) (*proto.FabricCredentialsResponse, error) {
...
// 	}
//
// 	return proto.NewFabricCredentialsResponse(user, secretToken, secretPath, accessToken), nil
// }
//
// // AuthWithSigningIdentity implements AccessServiceServer gRPC service RPC.
// func (s accessService) AuthWithSigningIdentity(
// 	ctx context.Context,
// 	request *proto.CertificateAuthRequest,
// ) (*proto.CertificateAuthResponse, error) {
...
// 	}
//
// 	return proto.NewCertificateAuthResponse(user, accessToken), nil
// }
