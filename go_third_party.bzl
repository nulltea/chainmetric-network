...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:sJ0MaOGfNeJWD+DiBjL4VTwrUJrFdiq5sF5b4wPgS+o=",
        version = "v0.8.0",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_hyperledger_fabric_chaincode_go",
        importpath = "github.com/hyperledger/fabric-chaincode-go",
        sum = "h1:1i4lnpV8BDgKOLi1hgElfBqdHXjXieSuj8629mwBZ8o=",
        version = "v0.0.0-20200424173110-d7076418f212",
    )
    go_repository(
        name = "com_github_hyperledger_fabric_config",
        importpath = "github.com/hyperledger/fabric-config",
        sum = "h1:khRkm8U9Ghdg8VmZfptgzCFlCzrka8bPfUkM+/j6Zlg=",
        version = "v0.0.5",
    )
    go_repository(
        name = "com_github_hyperledger_fabric_contract_api_go",
        importpath = "github.com/hyperledger/fabric-contract-api-go",
        sum = "h1:gDhOC18gjgElNZ85kFWsbCQq95hyUP/21n++m0Sv6B0=",
        version = "v1.1.1",
    )
    go_repository(
        name = "com_github_hyperledger_fabric_lib_go",
        importpath = "github.com/hyperledger/fabric-lib-go",
        sum = "h1:UL1w7c9LvHZUSkIvHTDGklxFv2kTeva1QI2emOVc324=",
        version = "v1.0.0",
    )
    go_repository(
        name = "com_github_hyperledger_fabric_protos_go",
        importpath = "github.com/hyperledger/fabric-protos-go",
        sum = "h1:SEbB3yH4ISTGRifDamYXAst36gO2kM855ndMJlsv+pc=",
        version = "v0.0.0-20200707132912-fee30f3ccd23",
    )
    go_repository(
        name = "com_github_hyperledger_fabric_sdk_go",
        importpath = "github.com/hyperledger/fabric-sdk-go",
        sum = "h1:oEe76aOtdYHGIK444LLhud6Hj5GHU7PZACzG3Y1sVcg=",
        version = "v1.0.1-0.20210603143513-14047c6d88f0",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_kellydunn_golang_geo",
        importpath = "github.com/kellydunn/golang-geo",
        sum = "h1:A5j0/BvNgGwY6Yb6inXQxzYwlPHc6WVZR+MrarZYNNg=",
        version = "v0.7.0",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_m1_go_generate_password",
        importpath = "github.com/m1/go-generate-password",
        sum = "h1:hjY9qHvq/8eFq3FZx+A/QmaByjpZOOM59x7PEJoooeo=",
        version = "v0.1.1",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_timoth_y_chainmetric_core",
        importpath = "github.com/timoth-y/chainmetric-core",
        sum = "h1:UGEpGYw4n3rdp5Xaok4/JMIyManiZlqqyW3RnadGjMc=",
        version = "v0.0.0-20210627221658-07365c2edb0d",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_ztrue_shutdown",
        importpath = "github.com/ztrue/shutdown",
        sum = "h1:GKR2ye2OSQlq1GNVE/s2NbrIMsFdmL+NdR6z6t1k+Tg=",
        version = "v0.1.1",
    )
    go_repository(
